package kit.develop.java.seminar_2.canvas.draw_pic.sprites;

import kit.develop.java.seminar_2.canvas.common.MainCanvas;
import kit.develop.java.seminar_2.canvas.common.Sprite;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("JavaDevKit/src/kit/develop/java/seminar_2/canvas/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
